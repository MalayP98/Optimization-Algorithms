...
class Visualize:
  ...
  def plot_type(self, type_ = None, res = 100, hzr_angle = None, ver_angle = None, x_axis = None, y_axis = None, z_axis = None):
    if type_ == 'contour':
      ...
      if self.plot_transition: plt.scatter(self.theta1, self.theta2)
      plt.show()
      ...
      if self.plot_transition: ax.scatter3D(self.theta1, self.theta2, self.error, c='black')
...
viz.plot('3d', res = 100, hzr_angle=50, ver_angle=80)
